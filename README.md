...
Portfólio pessoal desenvolvido para apresentar projetos, habilidades e experiência como desenvolvedor Front-End. Fui fisioterapeuta por 10 anos — hoje construo interfaces que as pessoas conseguem usar de verdade.
...
![Preview do portfólio](src/img/preview.png)
...
| Font Awesome | Ícones |
| Simple Icons | Ícones de tecnologias (Vite, Tailwind) |
| Google Fonts | Tipografia (Outfit + Kaushan Script) |
...
- 🖼 **Imagens em preto e branco** com revelação de cor no hover
...
Desenvolvedor Front-End com background em fisioterapia — o que traz um olhar analítico e centrado no usuário para cada projeto. Atualmente cursando Análise e Desenvolvimento de Sistemas pela UNINTER e participando da Residência em TIC-12 (Trilha Full Stack) pela UFC.
